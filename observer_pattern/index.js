...
class ObserverList {
	constructor() {
		this.observerList = [];
		ObserverList.instances.push(this);
	}
	static instances = [];
...
const addNewObserver = () => {
	...
	// set the state to match the control checkbox
	check.checked = controlCheckbox.element.checked;
...
console.log(ObserverList.instances);
